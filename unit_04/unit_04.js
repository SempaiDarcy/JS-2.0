...
//  которая выводите в .out-3 число 3. Т.е. как видите, мы можем повеcить клик на любой элемент.
...
function f4() {
    let a4 = document.querySelector('.i-4');
     document.querySelector('.out-4').innerHTML = a4.checked;
}
...
function f5() {
    if(a5.checked){
        document.querySelector('.out-5').innerHTML = a5.value;
    }
    else{
...
function f6() {
    let a6 = document.querySelector('.i-6');
    document.querySelector('.out-6').innerHTML = a6.value;
...
function f12() {
let a12 = document.querySelector('.i-12');
document.querySelector('.out-12').innerHTML = a12.value ;
}
...
function f13() {
let a13 = document.querySelector('.i-13');
document.querySelector('.out-13').innerHTML = a13.value;
}
...
function f14() {
let a14 = document.querySelector('.t-14');
document.querySelector('.out-14').innerHTML = a14.value;
}
...
document.querySelector('.t-15').innerHTML = a15.value;
document.querySelector('.out-15').innerHTML = a15.value;
...
let a16 = document.querySelector('.s-16');
document.querySelector('.out-16').innerHTML = a16.value;
}
...
function f17() {
let a17 = document.querySelector('.s-17');
document.querySelector('.out-17').innerHTML = a17.value;
}
...
function f18() {
    let a18 = document.querySelector('.s-18');
    let b18 = document.querySelector('.i-18');
    b18.value = a18.value;
}
...
function f19() {
    let a19 = document.querySelector('.out-19').innerHTML;
