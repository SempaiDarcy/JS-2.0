...
function t1() {
    ...
    document.querySelector('.out-1').innerHTML = a1.innerHTML;
    return a1;
}
...
function t3() {
    ...
    document.querySelector('.out-3').innerHTML = this.style.width;
}
...
function t5() {
    let elem = document.querySelector('.div-5');
    elem.classList.toggle('active');
}

document.querySelector('.block.div-5.active').ondblclick = t5;
// ваше событие здесь!!!
...
document.querySelector('.block.div-6').ondblclick = t6;
// ваше событие здесь!!!
...
function t7() {
    let elem = document.querySelector('.div-7');
    elem.classList.toggle('active');
}
...
document.querySelector('.div-11').onmousemove = t11;
...
const t12 = () => div12.classList.add('active');
...
const t13 = () => div13.classList.add('active');

const t13_1 = () => div13.classList.remove('active');
...
function t15() {
    div15++;
    document.querySelector('.div-15').textContent = div15;
...
function t18() {
    let w = document.querySelector('.div-18.block').offsetWidth;
    document.querySelector('.out-18').innerHTML = w;
}
...
function t19() {
    ...
    b19 = div19.className;
    document.querySelector('.out-19').innerHTML = b19;
}
