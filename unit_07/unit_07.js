...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Akbar');
}
...
function t7() {
    ...
    return out7.style.backgroundColor='rgb('+r+','+g+','+b+')';
...
document.querySelector('.b-9').onclick = function () {
    document.querySelector('.out-9').textContent = t9(61);
}
...
document.querySelector('.b-10').onclick = function () {
    document.querySelector('.out-10').textContent = t10(31, 31);
}
