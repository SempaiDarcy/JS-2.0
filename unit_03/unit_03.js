...
// Функция должна прочитать содержимое .i-1 и сравнить его с числом 4 (сравнение ==). Результат сравнения - true или false выведите в .out-1.
...
function f5(){
let number5 = +document.querySelector('.i-5').value;
if (number5<0){
...
function f7(){
    ...
    document.querySelector('.out-7').innerHTML = Math.pow(i71,i72);
}
...
let b10 = document.querySelector('.out-10');
b10.innerHTML = a10;
}
...
function f14(){
    ...
    let d14 = document.querySelector('.out-14');
    if (c14 === '+'){
        d14.innerHTML = a14+b14;
    }
    else if (c14 === '-'){
        d14.innerHTML = a14-b14;
    }
...
if(c15==='||'){
  document.querySelector('.out-15').innerHTML = a15 || b15;
}
else{
    document.querySelector('.out-15').innerHTML = a15 && b15;
}
