...
document.querySelector('.out-3').innerHTML = sum3;
}
...
document.querySelector('.out-4').innerHTML = sum4;
}
...
document.querySelector('.out-5').innerHTML = sum5;
}
...
document.querySelector('.out-6').innerHTML = sum;
}
...
document.querySelector('.out-7').innerHTML = sum7;
}
...
document.querySelector('.out-8').innerHTML = sum8;
}
...
document.querySelector('.out-9').innerHTML = sum9;
}
...
document.querySelector('.out-10').innerHTML = sum10;
}
...
while (p<div11.length){
    sum11 += div11[p].innerHTML + '_';
    p++;
}
document.querySelector('.out-11').innerHTML = sum11;
}
...
document.querySelector('.out-15').innerHTML = sum15;
}
