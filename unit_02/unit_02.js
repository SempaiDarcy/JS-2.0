...
function t9() {
    let data_1 = document.querySelector('.i-9').value;
    document.querySelector('.out-9').innerHTML = data_1;
...
function t10() {
let data_2 = document.querySelector('.i-10').value;
document.querySelector('.out-10').innerHTML = data_2*20;
document.querySelector('.out-10').value = '';
}
...
document.querySelector('.out-11').innerHTML = data3+55;
}
...
let b12 = document.querySelector('.i-12-2').value;
document.querySelector('.out-12').innerHTML = 'Hello' + ' '+ a12 + ' ' + b12;
}
